...
const Icon = ({ name }: { name: string }) => {
  const icons: { [key: string]: React.ReactNode } = {
    ...
    enhance: <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M11.49 3.17c-.38-1.56-2.6-1.56-2.98 0L8 5.482a1 1 0 01-.944.659l-2.37.094c-1.64.065-2.29 2.13-1.09 3.22l1.78 1.636a1 1 0 01-.33 1.702l-1.99 1.05c-1.46.77-1.02 2.92.57 3.42l2.36.72a1 1 0 01.76.994l.32 2.45c.23 1.71 2.52 1.71 2.75 0l.32-2.45a1 1 0 01.76-.994l2.36-.72c1.59-.49 2.02-2.65.57-3.42l-1.99-1.05a1 1 0 01-.33-1.702l1.78-1.636c1.2-1.1 1.55-3.15-.09-3.22l-2.37-.094a1 1 0 01-.944-.659L11.49 3.17z" clipRule="evenodd" /></svg>,
    upscale: <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor"><path d="M3 3a1 1 0 00-1 1v12a1 1 0 102 0V5.414l7.293 7.293a1 1 0 001.414-1.414L5.414 4H8a1 1 0 100-2H4a1 1 0 00-1 1z" /><path d="M14 10a1 1 0 011 1v4a1 1 0 01-1 1h-4a1 1 0 110-2h3v-3a1 1 0 011-1z" /></svg>,
